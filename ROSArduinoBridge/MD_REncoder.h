...
/**
 \def ENABLE_ROTATION_COUNT
 Set this to 0 to disable the code and storage used to calculate the encoder rotation speed.
 */
#define ENABLE_ROTATION_COUNT      1
...
class MD_REncoder
{
   ...
   */
    ...
    void resetCount(void);   // reset the encoder count to 0
    long getCount(void);     // return the encoder count
#endif
...
#if ENABLE_ROTATION_COUNT    
    // Rotation Data
    long  _rotationCount;   // running count of encoder clicks
#endif
};
